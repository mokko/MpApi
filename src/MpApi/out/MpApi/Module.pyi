...
class Module(Helper):
    ...
    def dataField(
        self, parent: ET, name: str, *, dataType: str = ..., value: str = ...
    ) -> ET: ...
    ...
    def moduleItem(
        self, parent: ET, ID: int, *, hasAttachments: strNone = ...
    ) -> ET: ...
    def moduleReference(
        self,
        parent: ET,
        name: str,
        *,
        targetModule: strNone = ...,
        multiplicity: strNone = ...
    ) -> ET: ...
    ...
    def vocabularyReference(
        self, parent: ET, name: str, instanceName: str, *, ID: int = ...
    ) -> ET: ...
    def vocabularyReferenceItem(
        self, parent: ET, name: str, *, ID: int = ...
    ) -> ET: ...
